...
_HELP_BINDINGS: list[tuple[str, str]] = [
    ...
    ("g", "Queue 'go ahead'"),
    ("Ctrl+g", "Open preset message dialog"),
    ("h", "Message history"),
    ("Ctrl+k", "Kill Hippeus"),
    ("Ctrl+Alt+k", "Kill tmux session process"),
    ("z", "Invoke Hippeus / Stygian / Polemarch / God"),
    ("b", "Broadcast share payload (ZEUS_MSG_FILE or %%%% block)"),
    ("n", "Queue next task"),
    ("m", "Direct-send share payload"),
    ("Ctrl+Alt+m", "Memory consolidation dialog"),
    ("", "─── Navigation ───"),
    ...
    ("", "─── Interact Panel ───"),
    ("Ctrl+a / Ctrl+e", "Move to line start / end; at edge jump prev/next line"),
    ("Ctrl+s", "Send message to Hippeus / tmux"),
    ("Ctrl+w", "Queue message (Alt+Enter in pi)"),
    ("Ctrl+u", "Clear input"),
    ("Ctrl+y", "Yank killed text (clipboard, fallback kill buffer)"),
